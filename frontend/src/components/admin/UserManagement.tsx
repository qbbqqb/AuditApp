...
const UserManagement: React.FC = () => {
  ...
  const getRoleBadgeColor = (role: string) => {
    const colors = {
      ...
      client_safety_manager: 'bg-blue-100 text-blue-800 border-blue-200',
      client_project_manager: 'bg-green-100 text-green-800 border-green-200',
      gc_ehs_officer: 'bg-purple-100 text-purple-800 border-purple-200',
      gc_project_manager: 'bg-yellow-100 text-yellow-800 border-yellow-200',
      gc_site_director: 'bg-gray-100 text-gray-800 border-gray-200'
    };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="client_safety_manager">Client Safety Manager</option>
                  <option value="client_project_manager">Client Project Manager</option>
                  <option value="gc_ehs_officer">GC EHS Officer</option>
                  <option value="gc_project_manager">GC Project Manager</option>
                  <option value="gc_site_director">GC Site Director</option>
                </select>
              </div>
            </div>
          </div>
